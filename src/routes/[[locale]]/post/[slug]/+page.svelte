...
<article class="article">
	...
	<header class="article-header container container-narrow">
		{#if post.categories && post.categories.length > 0}
			<div class="article-meta">
				<a href="{base}{localePrefix}/category/{post.categories[0].toLowerCase()}/" class="article-category">
					{post.categories[0]}
				</a>
			</div>
		{/if}
		...
		<div class="article-tags container container-narrow">
			...
			<div class="tags-list">
				{#each post.tags as tag}
					<a href="{base}{localePrefix}/tag/{tag.toLowerCase()}/" class="tag">{tag}</a>
				{/each}
			</div>
		</div>
	{/if}
	...
	{#if relatedPosts.length > 0}
		<section class="related-posts container">
			<h2 class="section-title">{t('Related Posts')}</h2>
